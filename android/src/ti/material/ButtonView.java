...
public class ButtonView extends TiUIView
{
	...
	public ButtonView(final TiViewProxy proxy)
	{
		super(proxy);
	...
	public void processProperties(KrollDict d)
	{
		...
		if (d.containsKey(TiC.PROPERTY_IMAGE)) {
			...
			if (canApplyTouchFeedback(d)) {
				rippleColor = d.containsKey("rippleColor") ? TiConvert.toString(d, "rippleColor") : null;
				applyTouchFeedback(bgColor, d.containsKey("rippleColor") ? TiConvert.toColor(d, "rippleColor") : bgColor);
			} else {
	 ...
	 */
	protected boolean canApplyTouchFeedback(KrollDict props) {
		return ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) && props.optBoolean("rippleColor", false));
	}
	 ...
	 */
	private void applyTouchFeedback(Integer backgroundColor, Integer rippleColor) {
		if (rippleColor == null) {
	...
	public void setRippleColor(String rippleColor_) {
	    Log.d(TAG, "Tried setting message to: " + rippleColor);
		rippleColor = rippleColor_;
	}
